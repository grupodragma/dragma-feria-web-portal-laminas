(function ($) {
    $.fn.floatingWhatsApp = function (options) {
        ...
        //#region Main Button
        $buttonImageContainer.addClass('floating-chat-button-image');

        $button.addClass('floating-chat-button')
        ...
        if (settings.showPopup) {
            ...
            $popup.addClass('floating-chat-popup');
            $header.addClass('floating-chat-head');
            $popupMessage.addClass('floating-chat-message');
            $inputMessage.addClass('floating-chat-input-message');
            $btnSend.addClass('floating-chat-btn-send');
